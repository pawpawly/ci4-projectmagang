...
<div class="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-md mt-10">
    ...
    <form id="categoryForm" action="<?= site_url('superadmin/koleksi/category/save') ?>" method="POST">
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea id="deskripsi_kkoleksi" name="deskripsi_kkoleksi" rows="4"
                      class="mt-1 px-4 py-2 w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent"><?= old('deskripsi_kkoleksi') ?></textarea>
        </div>
