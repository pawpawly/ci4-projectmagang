            ...
            <div class="mt-1 flex space-x-4">
                <label>
                    <input type="radio" name="level_user" value="1" 
                        <?= $user['LEVEL_USER'] == '1' ? 'checked' : ''; ?>> Admin
                </label>
                <label>
                    <input type="radio" name="level_user" value="2" 
                        <?= $user['LEVEL_USER'] == '2' ? 'checked' : ''; ?>> Superadmin
                </label>
            </div>
        </div>
...
<!-- Modal untuk Konfirmasi Simpan Perubahan -->
<div id="confirmModal" class="hidden fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
    <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <p>Apakah Anda yakin ingin menyimpan perubahan pada data pengguna ini?</p>
        <div class="mt-6 flex justify-end space-x-4">
