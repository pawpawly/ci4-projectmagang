  ...
  <div class="container mx-auto flex justify-between items-center py-4 px-6">
    ...
    <div class="flex-1 flex justify-center">
      <nav class="space-x-8 flex items-center">
        <a href="<?= site_url('./');?>" class="text-gray-800 hover:text-gray-600 font-semibold">Beranda</a>
        <a href="<?= site_url('schedule');?>" class="text-gray-800 hover:text-gray-600 font-semibold">Jadwal</a>
        <a href="<?= site_url('koleksi'); ?>" class="text-gray-800 hover:text-gray-600 font-semibold">Koleksi</a>
        <a href="<?= site_url('bukudigital'); ?>" class="text-gray-800 hover:text-gray-600 font-semibold">E-Book</a>
        <a href="<?= site_url('event/index'); ?>" class="text-gray-800 hover:text-gray-600 font-semibold">Event</a>
