...
<div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md mt-10">
    ...
    <form id="tambahBukuDigitalForm" action="<?= site_url('admin/bukudigital/save') ?>" 
...
<div class="mb-6">
    ...
    <div class="mt-6 flex justify-end space-x-4">
        <a href="<?= site_url('admin/bukudigital/manage') ?>" class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600">Batal</a>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        fetch('<?= site_url('admin/bukudigital/save') ?>', {
            method: 'POST',
            body: formData,
        })
