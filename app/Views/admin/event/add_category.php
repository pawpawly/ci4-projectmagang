...
<div class="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-md mt-10">
    ...
    <form id="categoryForm" autocomplete="off" action="<?= site_url('admin/event/category/save') ?>" method="POST">
    <?= csrf_field(); ?>
        <div class="mb-4">
        ...
        <div class="mt-6 flex justify-end space-x-4">
            <a href="<?= site_url('admin/event/category') ?>"
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        fetch('<?= site_url('admin/event/category/save') ?>', {
            method: 'POST',
            body: formData,
            headers: {
        ...
        .then(data => {
            ...
            if (data.success) {
                Swal.fire({
                    ...
                    window.location.href = '<?= site_url('admin/event/category') ?>';
                });
            } else {
