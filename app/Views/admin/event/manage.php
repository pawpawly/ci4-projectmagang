...
<div class="bg-white min-h-screen">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?= site_url('admin/event/add') ?>" 
    ...
    <form method="get" action="<?= site_url('admin/event/manage') ?>" class="flex items-center space-x-4 mb-6">
    <?= csrf_field(); ?>
            ...
            <tr class="border-b transition duration-75 hover:bg-gray-300">
                ...
                <td class="py-4 px-4 text-center">
                    <div class="flex justify-center items-center space-x-2">
                        <!-- Tombol Lihat Detail -->
                        <a href="<?= site_url('admin/event/detail/' . $event['ID_EVENT']) ?>" 
                        ...
                        <!-- Tombol Edit -->
                        <a href="<?= site_url('admin/event/edit/' . $event['ID_EVENT']) ?>" 
...
echo view('pagers/admin_pagination', [
    ...
    'baseUrl' => site_url('admin/event/manage'),
...
function deleteEvent(id_event) {
    fetch(`<?= site_url('admin/event/delete/') ?>${id_event}`, {
