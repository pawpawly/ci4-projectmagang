...
<div class="bg-white min-h-screen">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?= site_url('admin/event/category/add') ?>" 
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white shadow-md rounded-lg">
            <thead class="bg-gray-600">
                <tr>
                    <th class="text-left text-white py-2 px-4">Jenis Acara</th>
                    <th class="text-left text-white py-2 px-4">Deskripsi Acara</th>
                ...
                <tr class="border-b transition duration-75 hover:bg-gray-300">
                    ...
                    <td class="py-2 px-4 text-center">
                        <div class="flex justify-center items-center space-x-2">
                            <!-- Tombol Edit -->
                            <a href="<?= site_url('admin/event/category/edit/' . $category['ID_KEVENT']) ?>" 
...
echo view('pagers/admin_pagination', [
    ...
    'baseUrl' => site_url('admin/event/category'), // Base URL untuk pagination
...
<script>
    ...
    function deleteCategory(id_kevent) {
        fetch(`<?= site_url('admin/event/category/delete/') ?>${id_kevent}`, {
            method: 'DELETE',
            headers: {
