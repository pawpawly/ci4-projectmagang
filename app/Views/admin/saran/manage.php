...
<div class="bg-white min-h-screen">
    ...
    <div class="flex items-center mb-4 space-x-4">
        <form method="get" action="<?= site_url('admin/saran/manage') ?>" class="flex items-center space-x-4">
        <?= csrf_field(); ?>
            <!-- Input Pencarian -->
            <div>
                        ...
                        <tr class="border-b transition duration-75 hover:bg-gray-300">
                            ...
                            <td class="py-2 px-4 text-center">
                                <div class="flex justify-center items-center space-x-2">
                                    <!-- Tombol Lihat Saran -->
                                    <a href="<?= site_url('admin/saran/detail/' . $saran['ID_SARAN']); ?>"
...
echo view('pagers/admin_pagination', [
    ...
    'baseUrl' => site_url('admin/saran/manage'), // Base URL untuk pagination
...
<script>
    ...
    function deleteSaran(id_saran) {
        fetch(`<?= site_url('admin/saran/delete/') ?>${id_saran}`, {
            method: 'DELETE',
            headers: {
