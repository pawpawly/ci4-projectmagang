...
<div class="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-md mt-10">
    ...
    <form id="koleksiForm" action="<?= site_url('admin/koleksi/update') ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
    <?= csrf_field(); ?>
...
<script>
    ...
    document.getElementById('koleksiForm').addEventListener('submit', function (e) {
        ...
        fetch('<?= site_url('admin/koleksi/update') ?>', {
            method: 'POST',
            body: formData
        })
        ...
        .then(data => {
            ...
            if (data.success) {
                Swal.fire({
                    ...
                    window.location.href = '<?= site_url('admin/koleksi/manage') ?>';
                });
            } else {
                Swal.fire({
                    title: 'Oops!',
