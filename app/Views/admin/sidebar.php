...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Dropdown Event
    if (currentUrl.includes('admin/event/')) {
    ...
    // Dropdown Koleksi
    if (currentUrl.includes('admin/koleksi/')) {
...
<body class="bg-white">
    <div class="flex">
        ...
        <div class="w-64 bg-gray-600 text-white sidebar fixed h-screen">
            ...
            <ul class="mt-6">
                <li class="px-4 py-2 hover:bg-gray-500">
                    <a href="<?= site_url('admin/dashboard'); ?>" class="flex items-center space-x-4">
                ...
                <li class="px-4 py-2 hover:bg-gray-500">
                    <a href="<?= site_url('admin/bukutamu/manage'); ?>" class="flex items-center space-x-4">
                ...
                <li class="px-4 py-2 hover:bg-gray-500">
                    <a href="<?= site_url('admin/reservasi/manage'); ?>" class="flex items-center space-x-4">
                ...
                <li class="px-4 py-2 hover:bg-gray-500">
                    <a href="<?= site_url('admin/berita/manage'); ?>" class="flex items-center space-x-4">
        ...
        <li class="px-4 py-2 hover:bg-gray-500">
            <a href="<?= site_url('admin/bukudigital/manage'); ?>" class="flex items-center space-x-4">
                ...
                <li class="px-4 py-2 hover:bg-gray-500">
                <a href="<?= site_url('admin/saran/manage'); ?>" class="flex items-center space-x-4">
                ...
                <li class="px-4 py-2 hover:bg-gray-500">
                    ...
                    <ul id="eventDropdown" class="hidden mt-2 pl-6">
                        <li class="py-1">
                            <a href="<?= site_url('admin/event/category'); ?>" class="text-white hover:text-yellow-300">• Kategori Event</a>
                        </li>
                        <li class="py-1">
                            <a href="<?= site_url('admin/event/manage'); ?>" class="text-white hover:text-yellow-300">• Manajemen Event</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="px-4 py-2 hover:bg-gray-500">
                    ...
                    <ul id="koleksiDropdown" class="hidden mt-2 pl-6">
                        <li class="py-1">
                            <a href="<?= site_url('admin/koleksi/category'); ?>" class="text-white hover:text-yellow-300">• Kategori Koleksi</a>
                        </li>
                        <li class="py-1">
                            <a href="<?= site_url('admin/koleksi/manage'); ?>" class="text-white hover:text-yellow-300">• Manajemen Koleksi</a>
                        </li>
                    </ul>
                </li>
            </ul>
