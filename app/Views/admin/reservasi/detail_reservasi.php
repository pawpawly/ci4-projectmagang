...
<div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md mt-10">
    ...
    <div class="mt-6 flex justify-end space-x-4">
        ...
        <a href="<?= site_url('admin/reservasi/manage'); ?>" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">Kembali</a>
    </div>
</div>
...
function updateStatus(newStatus) {
    ...
    fetch(`<?= site_url('admin/reservasi/update-status/'); ?>${idReservasi}`, {
        method: 'POST',
        headers: {
