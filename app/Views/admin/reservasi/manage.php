...
<div class="bg-white min-h-screen">
    ...
    <div class="flex items-center mb-4 space-x-4">
        <form method="get" action="<?= site_url('admin/reservasi/manage') ?>" class="flex items-center space-x-4">
        <?= csrf_field(); ?>
            <!-- Input Pencarian -->
                    ...
                    <?php foreach ($reservasi as $item): ?>
                        <tr class="border-b transition duration-75 hover:bg-gray-300">
                            ...
                            <div class="flex justify-center text-center items-center space-x-2">
                                <a href="<?= site_url('admin/reservasi/detail/' . $item['ID_RESERVASI']); ?>" 
...
echo view('pagers/admin_pagination', [
    ...
    'baseUrl' => site_url('admin/reservasi/manage'), // Base URL untuk pagination
...
function deleteReservation(id_reservasi) {
    fetch(`<?= site_url('admin/reservasi/delete/') ?>${id_reservasi}`, {
        method: 'DELETE',
        headers: {
